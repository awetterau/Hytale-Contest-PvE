...
public final class NpcDefinitionRegistry {
    ...
    private void installFallbackBlacksmith() {
        NpcArchetype fallback = new NpcArchetype(
                ...
                List.of(),
                List.of("crude_dagger","iron_dagger","crude_sword","iron_sword","scrap_sword","crude_axe","iron_axe","crude_bow","iron_bow","crude_mace","iron_mace","scrap_mace","scrap_shield","iron_shield","crude_arrow","copper_helm","copper_chest","copper_gloves","copper_boots","iron_helm","iron_chest","iron_gloves","iron_boots","thorium_dagger","cobalt_dagger","thorium_sword","cobalt_sword","thorium_axe","cobalt_axe","thorium_bow","cobalt_bow","thorium_mace","cobalt_mace","thorium_shield","cobalt_shield","iron_crossbow","thorium_helm","thorium_chest","thorium_gloves","thorium_boots","cobalt_helm","cobalt_chest","cobalt_gloves","cobalt_boots","adamantite_dagger","adamantite_sword","adamantite_axe","adamantite_bow","adamantite_mace","adamantite_shield","adamantite_helm","adamantite_chest","adamantite_gloves","adamantite_boots"),
                List.of("follow"),
                false,
                null,
                false,
