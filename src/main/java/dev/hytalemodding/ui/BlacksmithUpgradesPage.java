...
public class BlacksmithUpgradesPage extends InteractiveCustomUIPage<BlacksmithUpgradesPage.Data> {
    ...
    public BlacksmithUpgradesPage(@Nonnull PlayerRef playerRef) {
    ...
    public void build(@Nonnull Ref<EntityStore> ref, @Nonnull UICommandBuilder ui, @Nonnull UIEventBuilder events, @Nonnull Store<EntityStore> store) {
        ...
        ui.append("Pages/BlacksmithUpgrades.ui");
    ...
    public void handleDataEvent(@Nonnull Ref<EntityStore> ref, @Nonnull Store<EntityStore> store, @Nonnull Data data) {
        ...
        if ("upgrade".equals(action)) {
            this.playerRef.sendMessage(Message.raw("Workshop upgrade requested (placeholder)."));
            return;
        }
